...
This project includes an automated testing and quality assurance suite using **Playwright** and **Webhint**.

### Local Development
To run tests and linting locally, ensure you have [Node.js](https://nodejs.org/) installed, then run:
...
### CI/CD Pipeline
The project is configured with **GitHub Actions**. Every time you push code to the `main` branch:
1. **Linting** is performed to ensure code quality.
2. **E2E Tests** are run on multiple browsers (Chromium & Mobile Safari).
3. **Auto-Deployment**: If all tests pass, the site is automatically deployed to GitHub Pages.
